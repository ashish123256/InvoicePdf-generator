...
import { generatePDF } from "../generatePdfApi";
    ...
    html += `
        ...
        <footer class="rounded-full bottom-10 bg-gradient-to-b from-gray-800 to-black absolute left-12 ml-5 w-5/6">
          <div class="px-8 py-4 mx-8">
            ...
            <p class="text-sm text-white">we are happy to supply any further information you may need and trust that you call on us to fill your order.
  ...
  if (currentUser) {
    return (
      <div className="container mx-auto p-4">
        <button
          className="left-0 bg-blue-500 text-white px-4 py-2 mb-4 rounded-md items-center font-bold hover:bg-black"
              ...
              <tr key={index}>
                ...
                <td className="flex justify-end px-4 py-7">
                  <button
                    ...
                    className="bg-red-500 rounded-md hover:bg-red-300 text-white px-6 py-2"
                  >
                    Remove
                  </button>
                </td>
        ...
        <div className="flex justify-end">
          <div className="text-gray-600 px-7 flex flex-col text-xl">
            ...
            <div className="flex justify-between font-bold mt-10 mb-2 border-b border-t border-x-0 pt-10 pb-10">
              Grand Total <span className="text-blue-500">₹ {total + (total * 0.18)}</span>
            </div>
          </div>
        </div>
        <button
